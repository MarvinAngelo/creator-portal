export function LayoutDashboard({ className = 'w-5 h-5' }) {
  return (
...
export function ArrowPathIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function ChatBubbleIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path fillRule="evenodd" d="M4.804 21.644A6.707 6.707 0 006 21.75a6.721 6.721 0 003.583-1.029c.428.045.857.07 1.287.07 4.578 0 8.25-3.192 8.25-7.5S15.38 5.25 10.803 5.25c-.55 0-1.09.04-1.617.115C8.132 3.028 6.646 2.25 5 2.25a2.25 2.25 0 00-2.196 2.544c.882.053 1.73.137 2.552.25A6.707 6.707 0 014.804 21.644z" clipRule="evenodd" />
    </svg>
  );
}

export function UserGroupIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function UnlinkIcon({ className = 'w-4 h-4' }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" />
    </svg>
